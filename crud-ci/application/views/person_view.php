...
<html>
    ...
    <body>
        <div class="container">
            <h1 style="font-size:20pt">CRUD</h1>
            <br />
        ...
        <script type="text/javascript">
            ...
            function edit_person(id)
            {
                ...
                $.ajax({
                    url : "<?= site_url('person/ajax_edit/') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            function save()
            {
                ...
                if (save_method == 'add') {
                    url = "<?= site_url('person/ajax_add') ?>";
                } else {
                    url = "<?= site_url('person/ajax_update') ?>";
                }
            ...
            function delete_person(id)
            {
                if (confirm('Tem certeza de que deseja excluir esses dados?')) {
                    $.ajax({
                        url : "<?= site_url('person/ajax_delete') ?>/"+id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data) {
                            $('#modal_form').modal('hide');
